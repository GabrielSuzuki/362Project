...
# to display messsages in html
from django.contrib import messages
from django.http import HttpResponse, JsonResponse
# Pagination of pages
from django.core.paginator import Paginator
# to get rid of browser cache browsing
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            try:
                ...
                currentDueDate = gettheduedate(
                    currentSublist.startDate, currentSublist.renewalcycle)
...
def editusersub(request, id):
    ...
    if request.method == 'POST':
        form = SubscirptionEditForm(
            request.POST, request.FILES, instance=sublistid)
        if form.is_valid():
            try:
                form.instance.author = request.user
